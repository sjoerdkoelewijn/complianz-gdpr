...
class cmplz_tour {
	...
	public function enqueue_assets( $hook ) {
		...
		if ( get_site_option( 'cmplz_tour_started' ) ) {
			...
			$logo
				   = '<span class="cmplz-tour-logo"><img class="cmplz-tour-logo" style="width: 70px; height: 70px;" src="'
				     . cmplz_url . 'assets/images/icon-256x256.png"></span>';
			...
			$steps = array(
				...
				3 => array(
					...
					'link'   => add_query_arg( array(
						...
						'id'   => cmplz_get_default_banner_id()
					), admin_url( "admin.php" ) ),
					'attach' => '.cmplz-menu-item',
				),
				4 => array(
				...
				7 => array(
					...
					'text'   => __( "Complianz tracks changes in your Cookie Notice and Cookie Policy with time-stamped documents. This is your consent registration while respecting the data minimization guidelines and won't store any user data.",
						'complianz-gdpr' ),
					'link'   => admin_url( "admin.php?page=cmplz-wizard" ),
					'attach' => '#cmplz-cookiestatement-snapshot-filter',
				),
				8 => array(
